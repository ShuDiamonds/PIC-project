...
/************* I/O Define  **********************/
/// Rotally Encoder
#define	encoder_a	PORTAbits.RA4
#define	encoder_b	PORTAbits.RA5
#define  stepSW		PORTAbits.RA3
/// DDS
#define	dds_fsync	LATAbits.LATA2
#define	dds_sclk		LATAbits.LATA1
#define	dds_sdat		LATAbits.LATA0
/// LCD Display
#define	lcd_port		LATB
#define 	lcd_stb 		LATBbits.LATB3
