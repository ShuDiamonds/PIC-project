...
{    
    ...
    0x09B9,                 // Vendor ID
    0x0048,                 // Product ID: PICDEM FS USB (DEMO Mode)
...
CFG01=
{
	...
	/// 新規インターフェース用追加
    /* Endpoint Descriptors */
    sizeof(USB_EP_DSC),DSC_EP,_EP02_OUT,_INT,USBIO_EP_SIZE,32,
    sizeof(USB_EP_DSC),DSC_EP,_EP02_IN,_INT,USBIO_EP_SIZE,32
};
