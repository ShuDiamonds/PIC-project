...
void Keyboard(void)
{
    ...
    {
        if(MOUSE_Click_Left == 0)
        {
        	//Load the HID buffer	//キーコード
        	
        	
        	hid_report_in[2] = 0x09;//f
        	hid_report_in[3] = 0x18;//u
        	hid_report_in[4] = 0x0E;//k
        	hid_report_in[5] = 0x18;//u
        	hid_report_in[6] = 0x07;//d
        	hid_report_in[7] = 0x04;//a
        	
           	//Send the 8 byte packet over USB to the host.
        	
        	/***参考*************
        	hid_report_in[0]に0x02を入れるとシフトキーを押したのと同じことになる
        	hid_report_in[0]に0x01を入れるとCtrlキーを押したのと同じことになる
